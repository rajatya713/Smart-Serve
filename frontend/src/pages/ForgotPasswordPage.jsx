                ...
                {success ? (
                    <div className="text-center">
                        ...
                        <button
                            ...
                            disabled={cooldown > 0}
                            className="text-sm text-blue-600 hover:text-blue-800 underline font-medium disabled:text-gray-400 disabled:cursor-not-allowed"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label htmlFor="forgot-email" className="text-gray-700 text-sm font-medium block mb-1">
                                Email Address
                            </label>
                            <input
                                id="forgot-email"
                                ...
                                className="w-full p-2.5 mt-1 text-sm bg-white/80 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none sm:p-3"
                            />
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-2.5 text-white font-semibold text-sm bg-blue-600 rounded-lg transition-all hover:bg-blue-700 duration-300 hover:scale-[1.03] disabled:opacity-60 disabled:cursor-not-allowed sm:py-3 cursor-pointer"
                        >
