            ...
            <div className="max-w-lg mx-auto">
                <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl shadow-2xl p-8 fade-in">
                    ...
                    <div className="bg-blue-50 rounded-xl p-5 mb-6 space-y-3 text-sm">
                        ...
                        <div className="flex justify-between text-gray-600">
                            <span>Pickup</span>
                            <span className="font-medium text-gray-800">{formatDate(booking.pickupDate)}</span>
                        </div>
                        <div className="flex justify-between text-gray-600">
                            <span>Drop-off</span>
                            <span className="font-medium text-gray-800">{formatDate(booking.dropoffDate)}</span>
                        </div>
                        <div className="flex justify-between text-gray-600">
                            <span>Location</span>
                        ...
                        <div className="flex justify-between text-gray-600">
                            <span>Delivery</span>
                            <span className="font-medium text-gray-800">{booking.deliveryRequired ? "Yes" : "No"}</span>
                        </div>
              ...
              hover:scale-[1.02] shadow-lg shadow-blue-200
